    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-zinc-400 text-sm">CEX Coins</p>
              <p className="text-2xl font-bold text-purple-400 mt-1">{data.bonusBalance.toLocaleString()}</p>
              {data.lockedCEX > 0 && (
                <p className="text-xs text-zinc-500 mt-1">+{data.lockedCEX.toLocaleString()} locked</p>
              )}
            </div>
