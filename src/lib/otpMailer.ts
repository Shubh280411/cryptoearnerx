...
export async function sendOTPEmail(email: string, otp: string): Promise<boolean> {
  try {
    await transporter.sendMail({
      ...
      to: email,
      subject: "Verify Your Email — CryptoEarnerX",
      html: `
<!DOCTYPE html>
<html>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#09090b;padding:40px 20px;">
    <tr><td align="center">
      <table width="480" cellpadding="0" cellspacing="0" style="background-color:#18181b;border-radius:16px;border:1px solid #27272a;overflow:hidden;">
        ...
        <!-- Header with Logo -->
        <tr><td style="background:linear-gradient(135deg,#1e3a5f 0%,#1e40af 50%,#3b82f6 100%);padding:32px 40px;text-align:center;">
          ...
          <p style="margin:6px 0 0;color:#93c5fd;font-size:13px;">Earn Crypto. Build Teams. Grow Wealth.</p>
        </td></tr>
        ...
        <tr><td style="padding:40px 40px 24px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr><td style="background-color:#09090b;border:1px solid #27272a;border-radius:12px;padding:24px;text-align:center;">
              ...
              <p style="margin:0;font-size:40px;font-weight:800;letter-spacing:10px;color:#3b82f6;font-family:'Courier New',monospace;">${otp}</p>
            </td></tr>
          </table>
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr><td style="background-color:#1e293b;border:1px solid #334155;border-radius:8px;padding:16px;">
              <p style="margin:0;color:#94a3b8;font-size:13px;line-height:1.5;">
                <strong style="color:#cbd5e1;">Didn't request this?</strong> You can safely ignore this email. Your account will not be created unless you verify with this code.
              </p>
            </td></tr>
          </table>
        </td></tr>
